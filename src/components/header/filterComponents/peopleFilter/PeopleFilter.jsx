...
const PeopleFilter = () => {
  ...
  return (
    <div className="flex  gap-5 ">
      <div className="flex flex-row items-center gap-4">
        ...
        <span onClick={()=>setOpenOptions(!openOptions)} className="md:cursor-pointer flex w-[100%] gap-10">
  ...
  `}
      ...
      {openOptions && <div className="flex absolute md:self-start sm:self-center h-max lg:top-[50px] md:bottom-[90px] sm:bottom-[-22rem] bg-white p-10 shadow-md rounded-md  flex-col gap-2">
        {/* Adult Count */}
